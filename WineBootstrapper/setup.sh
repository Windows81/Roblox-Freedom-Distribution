...
#Chmod 
chmod +x /home/$USER/RobloxFreedomDistribution/joinnew.sh
chmod +x /home/$USER/RobloxFreedomDistribution/hostnew.sh
chmod +x /home/$USER/RobloxFreedomDistribution/stopall.sh
