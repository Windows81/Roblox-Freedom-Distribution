...
--[[ Add "Roblox Filtering Disabled" CoreScripts; this isn't present in the original RCC logic. ]]--
ScriptContext:AddCoreScriptLocal("ServerCoreScripts/UwU", script.Parent)
