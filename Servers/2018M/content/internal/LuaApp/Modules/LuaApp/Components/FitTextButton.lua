...
FitTextButton.defaultProps = {
	fitAxis = FitChildren.FitAxis.Height,
}

function FitTextButton:init()
	...
	self.resize = function(rbx)
		...
		-- Unlike the other fit components, FitTextButton defaults to expanding only height, instead of
...
function FitTextButton:didMount()
	self.resize(self.ref)
end

return FitTextButton