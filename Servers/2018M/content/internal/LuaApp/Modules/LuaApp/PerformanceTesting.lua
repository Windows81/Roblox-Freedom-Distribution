	...
	local gui = Create.new "ScreenGui" {
		...
		Create.new "Frame" {
			...
			Create.new "TextLabel" {
				...
				Text = "Test: " .. Config.General.PerformanceTestFilename
			},
...
function PerformanceTesting:Stop()
	if Config.General.PerformanceTestingMode == Enum.VirtualInputMode.Recording then
...
function PerformanceTesting:Initialize(appState)
	...
	if Config.General.PerformanceTestingMode == Enum.VirtualInputMode.None then
		return
	end
	...
	if Config.General.PerformanceTestingMode == Enum.VirtualInputMode.Recording then
		self:Record()
	elseif Config.General.PerformanceTestingMode == Enum.VirtualInputMode.Playing then
		self:Play(Config.General.PerformanceTestFilename)
	end
end
