...
FocusHandler.validateProps = t.strictInterface({
	...
	currentHandlerId = t.optional(t.number),
	candidateHandlerId = t.optional(t.number),
	previousSelections = t.table,
	requestFocusForHandlerId = t.callback,
	forgetLastSelectionForHandlerId = t.callback,
	blurCurrentFocusHandler = t.callback,
...
function FocusHandler:didUpdate(oldProps)
	...
	local hasThisElementGainedFocus = self.props.currentHandlerId == self.id and oldProps.currentHandlerId ~= self.id
