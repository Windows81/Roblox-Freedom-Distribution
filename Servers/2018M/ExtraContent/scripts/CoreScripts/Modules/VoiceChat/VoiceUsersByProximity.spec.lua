...
return function()
	...
	beforeAll(function(c)
		...
		c.fflagVoiceAbuseReportsEnabled = game:SetFastFlagForTesting("VoiceAbuseReportsEnabledV2", true)
	...
	afterAll(function(c)
		...
		game:SetFastFlagForTesting("VoiceAbuseReportsEnabledV2", c.fflagVoiceAbuseReportsEnabled)
