...
local FPS = 30
local CIRCLE_IMAGE = Images["component_assets/circle_29"]
local CIRCLE_CUTOUT_IMAGE = "rbxasset://textures/ui/InGameMenu/CircleCutout.png"
local QUARTER_CIRCLE_IMAGE = "rbxasset://textures/ui/InGameMenu/QuarterCircle.png"
