return function()
	...
	local ProductPurchaseContainer = require(script.Parent.ProductPurchaseContainer)
	ProductPurchaseContainer = ProductPurchaseContainer.getUnconnected()
	...
	it("should create and destroy without errors", function()
		local element = Roact.createElement(UnitTestContainer, {
			...
			Roact.createElement(ProductPurchaseContainer)
		})
