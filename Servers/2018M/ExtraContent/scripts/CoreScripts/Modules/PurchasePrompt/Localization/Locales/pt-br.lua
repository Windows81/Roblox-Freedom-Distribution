...
Eu afirmo ter mais de 18 anos e/ou sou pai/mãe ou responsável legal do dono da conta. Autorizo esta compra e concordo com os Termos de Uso.]],
	...
	["CoreScripts.PurchasePrompt.PurchaseFailed.Enable2SVLogout"] = [[A verificação em duas etapas é necessária para fazer novas transações. Vá em Configurações > Segurança para completar a verificação. Ativar a verificação em duas etapas encerrará sua sessão atual.]],
