...
KeyMappings.PurchaseErrorKey = {
	...
	[PurchaseError.TwoFactorNeeded] = PURCHASE_FAILED_KEY:format("Enable2SV"),
	[PurchaseError.TwoFactorNeededSettings] = PURCHASE_FAILED_KEY:format("Enable2SV"),
	...
	[PurchaseError.InvalidFundsUnknown] = PURCHASE_FAILED_KEY:format("InvalidFunds"),
