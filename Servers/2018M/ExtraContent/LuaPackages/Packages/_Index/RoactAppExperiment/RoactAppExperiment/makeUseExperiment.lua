...
local function makeUseExperiment(
	...
	local useExperiment =
		function<T...>(layerNames: { string }, mapLayers: MapLayers<T...>, recordExposureOnMount: boolean?): T...
			...
			React.useEffect(function()
				...
				local onLoadingStatusChangeConnection = ixpService[onLayerLoadingStatusChanged]:Connect(
					function(_status)
