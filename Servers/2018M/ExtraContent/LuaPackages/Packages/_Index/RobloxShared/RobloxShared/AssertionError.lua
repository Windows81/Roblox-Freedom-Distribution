...
-- ROBLOX TODO: move to LuauPolyfill
...
-- ROBLOX deviation START: mock process to not change AssertionError internalce
local process = {
	stderr = {
		isTTY = false,
		columns = 0,
...
-- ROBLOX deviation START: using mocked isErrorStackTraceLimitWritable function
