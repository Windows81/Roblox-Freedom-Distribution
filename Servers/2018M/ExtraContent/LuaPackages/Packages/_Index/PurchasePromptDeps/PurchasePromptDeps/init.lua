...
return {
	...
	IAPExperience = require(PurchasePromptDependencies.IAPExperience),
	enumerate = require(PurchasePromptDependencies.enumerate),
	Promise = require(PurchasePromptDependencies.Promise),
	UrlBuilder = require(PurchasePromptDependencies.UrlBuilder),
}
