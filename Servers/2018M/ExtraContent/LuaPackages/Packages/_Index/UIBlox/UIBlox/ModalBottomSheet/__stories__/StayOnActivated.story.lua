...
-- Please only make changes to `src\Stories\Private\ModalBottomSheet\StayOnActivated.story.lua`
...
local overlayComponent = Roact.Component:extend("OverlayComponentStayOnActivated")
