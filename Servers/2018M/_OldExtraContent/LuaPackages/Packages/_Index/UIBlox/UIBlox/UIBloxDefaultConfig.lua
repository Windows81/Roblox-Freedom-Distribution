return {
	-- genericButtonPassesMaxSizeToGenericTextLabel: GenericButton will pass maxSize
	-- in to GenericTextLabel, so that text will be laid out properly (particularly in
	-- the case of multiline text)
	genericButtonPassesMaxSizeToGenericTextLabel = false,
