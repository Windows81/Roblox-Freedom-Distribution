...
function AppLayout:didUpdate(previousProps, _)
	if
		...
		and previousProps.messageHistory.RBXGeneral
		and self.props.messageHistory.RBXGeneral
		and Dictionary.count(previousProps.messageHistory.RBXGeneral)
			< Dictionary.count(self.props.messageHistory.RBXGeneral)
	then
