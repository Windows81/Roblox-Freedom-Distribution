...
--------------------------------------------------------------------------------------------------------]]
    ...
    ["IAPExperience.RobuxUpsell.Text.BuyRobuxQuestionWithWarning"] = [[适度娱乐，理性消费。你想要购买吗]],
    ...
    ["IAPExperience.PurchasePrompt.Text.BuyItemQuestionWithWarning"] = [[适度娱乐，理性消费。你想要购买“{name}“吗？]],
